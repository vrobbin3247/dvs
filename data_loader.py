...
class VideoDataset(Dataset):
    ...
    def __init__(self, mode, folder = "/home/emb-vaibman/data/DIF/dataset_10sec/all_videos/", 
                 file = "/home/emb-vaibman/data/DIF/dataset_10sec/video_files.csv"):
        """
		Args:
            folder: where videos are there (default: user's dataset path)
            file: the csv file (default: user's dataset path)
